...
const { LOB_KEY, LOB_UPSTREAM, PROXY_BODY_LIMIT, PROXY_TIMEOUT_MS } = require('./config');
...
module.exports = { PROXY_ALLOWLIST, proxyRequestAllowed, lobAuthorization, proxyTargetFor, handleProxy };
